        ...
        <div class="row">
            <div class="tab-pane fade Student-card active show" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="d-flex align-items-center justify-content-between py-4 nav-tab-heading">
                    <h4 class="heading mb-0">Add Scenario</h4>
                </div>
                <div class="gernal-info bg-white">
                    <div class="block">
                        <p class="mb-3">Please enter the required input fields in order to add a Scenario.</p>
                        <form  method="POST" action="{{ route('scenario.store') }}" enctype="multipart/form-data" >
                            ...
                            <div class="row pb-2">
                                <div class="col-md-6 pb-2">
                                    ...
                                    <input type="text" name="scenario_name" placeholder="Enter Scenario Name" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>Scenario id<span class="required">*</span></label>
                                    <input type="number" name="scenario_id" placeholder="Enter Scenario id" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>Scenario logo<span class="required">*</span></label>
