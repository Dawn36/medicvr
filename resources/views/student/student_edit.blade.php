        ...
        <div class="row">
            <div class="tab-pane fade Student-card active show" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="d-flex align-items-center justify-content-between py-4 nav-tab-heading">
                    <h4 class="heading mb-0">Edit Student</h4>
                </div>
                        ...
                        <form method="POST" action="{{ route('user.update',$student->id) }}" >
                            ...
                            <div class="row pb-2">
                                <div class="col-md-6 pb-2">
                                    ...
                                    <input type="text" name="first_name" value="{{$student->first_name}}" placeholder="Please Enter the First name of the student" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>Last Name<span class="required">*</span></label>
                                    <input type="text" name="last_name"  value="{{$student->last_name}}" placeholder="Please Enter the Last name of the student" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>Phone<span class="required">*</span></label>
                                    <input type="tel" name="phone_number" value="{{$student->phone_number}}" placeholder="Please Enter the Phone Number of the student" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>Email<span class="required">*</span></label>
                                    <input type="email" name="email" value="{{$student->email}}" placeholder="Please Enter the Email of the student" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>Unique ID<span class="required">*</span></label>
                                    <input type="number" name="unique_id" value="{{$student->unique_id}}" placeholder="Please Enter the Unique ID of the student" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
