        ...
        <div class="row">
            <div class="tab-pane fade Student-card active show" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="d-flex align-items-center justify-content-between py-4 nav-tab-heading">
                    <h4 class="heading mb-0">{{__('gobal.Edit Super Admin')}}</h4>
                </div>
                        ...
                        <form method="POST" action="{{ route('user.update',$superadmin->id) }}" >
                            ...
                            <div class="row pb-2">
                                <div class="col-md-6 pb-2">
                                    ...
                                    <input type="text" name="first_name" value="{{$superadmin->first_name}}" placeholder="{{__('gobal.first_name_placeholder')}}" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>{{__('gobal.last_name')}}<span class="required">*</span></label>
                                    <input type="text" name="last_name"  value="{{$superadmin->last_name}}" placeholder="{{__('gobal.last_name_placeholder')}}" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>{{__('gobal.phone')}}<span class="required">*</span></label>
                                    <input type="tel" name="phone_number" value="{{$superadmin->phone_number}}" placeholder="{{__('gobal.phone_placeholder')}}" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>{{__('gobal.email')}}<span class="required">*</span></label>
                                    <input type="email" name="email" value="{{$superadmin->email}}" placeholder="{{__('gobal.email_placeholder')}}" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
                                    <label>{{__('gobal.unique_id')}}<span class="required">*</span></label>
                                    <input type="number" name="unique_id" value="{{$superadmin->unique_id}}" placeholder="{{__('gobal.unique_id_placeholder')}}" class="form-control" required>
                                </div>
