        ...
        <div class="row">
            <div class="tab-pane fade Student-card active show" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="d-flex align-items-center justify-content-between py-4 nav-tab-heading">
                    <h4 class="heading mb-0">{{__('gobal.Edit Department')}}</h4>
                </div>
                        ...
                        <form  method="POST" action="{{ route('department.update',$department->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row pb-2">
                                <div class="col-md-6 pb-2">
                                    ...
                                    <input type="text" name="department_name" value="{{$department->name}}" placeholder="{{__('gobal.Please Enter the name of the department')}}" class="form-control" required>
                                </div>
                                <div class="col-md-6 pb-2">
