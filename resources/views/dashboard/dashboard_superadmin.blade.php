                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-center align-items-center my-3">
                            <img src="{{ asset($data['hospital_listing'][$i]->hospital_hi_rest_logo)}}" class="img-fluid" width="6%" alt="">
                            <h3 class="mx-1 my-3 fw-bolder fs-7 text-center">{{ucwords($data['hospital_listing'][$i]->hospital_name)}}</h3>
                        </div>
                        <!-- Start: Stats -->
                        <div class="row">
                            <div class="col">
